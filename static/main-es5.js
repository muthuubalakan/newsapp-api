...
var ApiServiceService = /** @class */ (function () {
    ...
    ApiServiceService.prototype.setKeyword = function (keyword) {
        this.searchKeyword.emit(keyword);
    };
    ApiServiceService.prototype.getKeyword = function () {
...
var NewsfeedComponent = /** @class */ (function () {
    ...
    NewsfeedComponent.prototype.getQueriedNews = function () {
        var _this = this;
        this.mainService.getKeyword().subscribe(function (keyword) {
            _this.keyword = keyword;
            _this.getNews(_this.keyword);
        });
    };
    NewsfeedComponent.prototype.getNews = function (keyword) {
        var _this = this;
        this.mainService.getRelatedNews(keyword).subscribe(function (resp) {
            _this.allNews = resp;
            _this.data = _this.allNews.pop();
            _this.fetchHeadlines();
        });
